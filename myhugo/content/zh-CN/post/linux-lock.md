...
> 最近公司项目因为一个自旋锁的原因，导致性能下降，换了轻量级的锁性能改善不好，在Linux下有各种锁比如互斥锁(mutex)、自旋锁(spin)、读写锁、文件锁、悲观锁、乐观锁，有时都分不清楚用法以及使用场景，这篇从[小林coding]摘录的介绍锁的文章讲解比较透彻，再次引用一下。
...
1. [面试官：你说说互斥锁、自旋锁、读写锁、悲观锁、乐观锁的应用场景 - 小林coding - 博客园](https://www.cnblogs.com/xiaolincoding/p/13675202.html)
