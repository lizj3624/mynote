> TLS握手的密钥交换很重要，理解密钥交换对理解HTTPS很有帮助，这片文章讲解ECDHE密钥交换简单易懂，收藏一下，[原文](https://mp.weixin.qq.com/s/pLyR8zuw4l7Z6sdUZ4IL5w)
...
![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-01.png)
...
![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-02.png)

那么对于底数为 2 的时候， 32 的对数是 5，64 的对数是 6，计算过程如下：

![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-03.png)

对数运算的取值是可以连续的，而离散对数的取值是不能连续的，因此也以「离散」得名，

离散对数是在对数运算的基础上加了「模运算」，也就说取余数，对应编程语言的操作符是「%」，也可以用 mod 表示。离散对数的概念如下图：

![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-04.png)
...
![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-05.png)
...
![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-06.png)
...
![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-07.png)

#### TLS 第二次握手

服务端收到客户端的「打招呼」，同样也要回礼，会返回「**Server Hello**」消息，消息面有服务器确认的 TLS 版本号，也给出了一个**随机数（\*Server Random\*）**，然后从客户端的密码套件列表选择了一个合适的密码套件。

![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-08.png)
...
![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-09.png)

这一步就和 RSA 握手过程有很大到区别了，因为服务端选择了 ECDHE 密钥协商算法，所以会在发送完证书后，发送「**Server Key Exchange**」消息。

![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-10.png)
...
![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-11.png)
...
![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-12.png)
...
![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-13.png)

接着，客户端会发「**Encrypted Handshake Message**」消息，把之前发送的数据做一个摘要，再用对称密钥加密一下，让服务端做个验证，验证下本次生成的对称密钥是否可以正常使用。

![图片](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/ecdhe-14.png)
