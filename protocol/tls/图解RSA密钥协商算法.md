> HTTPS中TLS握手有两种：RSA密钥协商算法和ECDHE密钥协商算法，但是RSA密钥协商算法不具有完全向前保密性(PFS)，已经被逐渐废弃掉，但是RSA密钥协商对我们理解TLS还有有一定帮助的，这篇讲解RSA密钥协商算法比较浅显易懂，收藏一下，[原文](https://mp.weixin.qq.com/s/U9SRLE7jZTB6lUZ6c8gTKg)

我很早之前写过一篇关于 HTTP 和 HTTPS 的文章，但对于 HTTPS 介绍还不够详细，只讲了比较基础的部分，所以这次我们再来深入一下 HTTPS，用**实战抓包**的方式，带大家再来窥探一次 HTTPS。

![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-01.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-02.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-03.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-04.png)

对应 Wireshark 的抓包，我也画了一幅图，你可以从下图很清晰地看到该过程：

![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-05.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-06.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-07.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-08.png)

随后，服务端发了「**Server Hello Done**」消息，目的是告诉客户端，我已经把该给你的东西都给你了，本次打招呼完毕。

![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-09.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-10.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-11.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-12.png)

操作系统里一般都会内置一些根证书，比如我的 MAC 电脑里内置的根证书有这么多：

![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-13.png)

这样的一层层地验证就构成了一条信任链路，整个证书信任链验证流程如下图所示：

![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-14.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-15.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-16.png)

然后，客户端再发一个「**Encrypted Handshake Message（Finishd）**」消息，把之前所有发送的数据做个摘要，再用会话密钥（master secret）加密一下，让服务器做个验证，验证加密通信是否可用和之前握手信息是否有被中途篡改过。

![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-17.png)
...
![img](https://github.com/lizj3624/mynote/blob/master/protocol/pictures/rsa-18.png)
